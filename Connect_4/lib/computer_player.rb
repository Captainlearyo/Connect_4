...
#       true
  ...
  def logic(board)
    if logic_check_rows(board)
      return logic_check_rows(board)
    elsif logic_check_columns(board)
      return logic_check_columns(board)
    elsif logic_check_rows_add_o(board)
      return logic_check_rows_add_o(board)
    elsif logic_check_columns_add_o(board)
      return logic_check_columns_add_o(board)
    elsif logic_check_diagonal_1(board)
